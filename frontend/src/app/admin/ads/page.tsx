...
import { Megaphone, LayoutTemplate, ShieldAlert, Code2 } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="glass-card rounded-[2.5rem] p-8 md:p-10 border border-white/80 shadow-sm relative overflow-hidden">
                    ...
                    <form className="space-y-8">
                        ...
                        <button type="button" className="w-full bg-slate-900 hover:bg-slate-800 text-white font-black py-4 rounded-2xl shadow-xl shadow-slate-900/20 transition-transform hover:-translate-y-1">
                            {isAr ? 'تطبيق وحفظ' : 'Apply & Save Configuration'}
                        </button>
                    </form>
                </div>
